...
The `queryOptions` object allows customising the search query. In this example, the `bias_postcode` property is set to "BR8 7RE" to bias the search results towards the BR8 7RE postcode.
